...
| `migration-batch-native-enrichment.md` | Migration plan: batch-native enrichment, deprecate the external worker (the branch's executable output). Ratified via [ADR-0007](../architecture/adr/0007-batch-native-enrichment-deprecate-worker.md) + [ADR-0008](../architecture/adr/0008-hermetic-with-explicit-api-seam.md). |
