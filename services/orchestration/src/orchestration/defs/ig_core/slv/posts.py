...
The state-table bootstrap lives here (`ensure_state_tables`) rather than in a
shared module because this asset is its heaviest caller; the sibling silver
assets import it from here.
"""
...
from orchestration.defs.platform.schemas import SILVER_COLUMNS, duckdb_ddl
...
def ensure_state_tables(db: DuckDBResource) -> None:
