...
| [`creator-discovery`](creator-discovery/epic.md) | E-DISCOVERY | **NEW** cost-governed creator discovery & tiering: audience-band discovery across niches, `suggested_core` (warehouse) vs core allocation (ops depth), owner-allocated via script (admin view deferred), reported monthly Apify cost | Active (US-DISC-7/8 implemented 2026-09-17, PR #89; US-DISC-1..6 open) | dlc-worker / sdlc-worker | E-IDENTITY, E-ENRICH-LABELS, E-SERVING-ANALYTICS | `tasks/plans/post-performance-observations-investigation.md` (cost model), ADR-0017 (roster boundary), US-DISC-1..8, `cross-check-2026-09-17.md` |
