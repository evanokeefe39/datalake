...
| [`enrich-facets`](enrich-facets/epic.md) | E-ENRICH-FACETS | **NEW** cross-modal growth facets (V3) + engagement-utility | Open (design) | dlc-worker | E-ENRICH-ENGINE, E-MEDIA, E-SERVING-ANALYTICS | `docs/architecture/pipelines/enrichment.md` (v3 canonical), `tasks/plans/silver-conform-tables`, `facet-list-experiment-design`, US-EFAC-1..4 |
