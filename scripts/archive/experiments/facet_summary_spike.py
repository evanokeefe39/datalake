...
from orchestration.defs.common.resources import GeminiResource, SQLiteResource  # noqa: E402
from orchestration.defs.enrichment import gemini_batch  # noqa: E402
from orchestration.defs.enrichment.prompts import _DEFAULT_GEMINI_MODEL  # noqa: E402
...
def _submit(gemini: GeminiResource, requests: list[dict], name: str,
    ...
    from orchestration.defs.instagram.config import GeminiTierConfig
